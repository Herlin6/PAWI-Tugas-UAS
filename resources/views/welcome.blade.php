        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-8 col-lg-6 p-lg-3">
                    ...
                    />
                    <h1 class="title-color font-playfair mb-3">Welcome</h1>
                    <p class="main-color font-playfair fs-5">
                    ...
                    <div class="d-grid gap-3 mt-4 w-75 mx-auto">
                        <x-button type="submit" class="btn btn-theme p-2" href="{{ route('login') }}">
                            <div class="font-playfair fs-5"><b>Login</b></div>
                        </x-button>
                        <x-dark-button type="submit" class="btn btn-theme p-2" href="{{ route('register') }}">
