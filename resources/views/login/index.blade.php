  ...
  <div class="row">
    <div class="col-md-6 p-5">
      <div class="text-center mb-4">
        <img src="assets/img/GDeBookLogo2.png" alt="Logo GDeBook" style="max-width: 120px;">
      ...
      <form method="POST" action="login">
        ...
        <button type="submit" class="btn btn-theme w-100 font-playfair">Login</button>

        <div class="text-center mt-3">
          <span class="sub-title-color font-playfair">Don't have an account? </span>
          <a href="#" class="sub-title-color font-playfair">Register</a>
        </div>
      </form>
    </div>

    <div class="col-md-6 p-0" style="margin: 0;">
      <div style="height: 100vh; width: 100%; overflow: hidden;">
        <img src="assets/img/foto-login.png" alt="Library" style="width: 100%; height: 100%; object-fit: cover;">
      </div>
    </div>
  </div>
</div>
